...
def process_data(config):
    ...
    for annot in data["annotations"]:
        ...
        my_dataframe.loc[cur_image_rows, ["x", "y", "w", "h"]] = [
            int(coord) for coord in annot["bbox"]
        ]
    ...
    for annot in data["images"]:
        ...
        my_dataframe.loc[cur_image_id, ["shapex", "shapey"]] = [
            int(annot["width"]),
            int(annot["height"]),
        ]
    ...
    my_dataframe[["shapex", "shapey", "x", "y", "w", "h"]] = my_dataframe[
        ["shapex", "shapey", "x", "y", "w", "h"]
    ].astype(int)
